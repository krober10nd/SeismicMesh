...
%   for jj = 1:length(bars)
%      p2(bars(jj,1),1) = p2(bars(jj,1),1) + deltat * Fvec(jj,1) ; 
%      p2(bars(jj,1),2) = p2(bars(jj,1),2) + deltat * Fvec(jj,2) ; 
%    
%      p2(bars(jj,2),1) = p2(bars(jj,2),1) - deltat * Fvec(jj,1) ;
%      p2(bars(jj,2),2) = p2(bars(jj,2),2) - deltat * Fvec(jj,2) ;
%   end
% %   
